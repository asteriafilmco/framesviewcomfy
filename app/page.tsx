...
export default function Page() {
    ...
    const [isSettingsOpen, setIsSettingsOpen] = useState<boolean>(false); // Add state for settings panel

    return (
        <ViewComfyProvider>
            <div className="relative flex flex-col h-screen w-full overflow-x-auto overflow-y-hidden">
                {/* Pass state and setter to TopNav */}
                <TopNav onSettingsToggle={() => setIsSettingsOpen(!isSettingsOpen)} />
